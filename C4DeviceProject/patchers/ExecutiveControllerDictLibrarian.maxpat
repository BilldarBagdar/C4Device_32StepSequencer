        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 697.0, 270.0, 24.0, 24.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 779.0, 384.0, 218.0, 22.0 ],
                    "text": "pack s s s s"
                }
            },
            {
            ...
            },
            {
                "box": {
                    "id": "obj-135",
                    "items": [ "all", ",", "sequence", ",", "pressed", ",", "released", ",", "shift", ",", "option", ",", "control", ",", "alt", ",", "lastIncrement" ],
                    "maxclass": "umenu",
                    "numinlets": 1,
                    "numoutlets": 3,
                    "outlettype": [ "int", "", "" ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 779.0, 415.0, 145.0, 22.0 ],
                    "text": "copySequenceToPage $1"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 488.5, 412.0, 47.0, 22.0 ],
                    "text": "print lib"
                }
            },
            {
